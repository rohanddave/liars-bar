...
/**
 * Enhanced display manager for GameTerminal with game state display capabilities.
 * Provides terminal display functionality including game state rendering,
 * player hand display, and claim information.
 */
public class SimpleDisplayManager {
     ...
     */
    public void renderGameState(List<Player> players, Player currentPlayer, int roundNumber, 
        ...
        // Player status
        renderPlayerStatus(players, currentPlayer);
        System.out.println();
        
        // Current claim if exists
        if (currentClaim != null) {
            renderCurrentClaim(currentClaim, currentRank);
            System.out.println();
        }
